...
export const ActivityPage: React.FC = () => {
  ...
  const [getActivities,data] = useApi<{ students: Person[] }>({ url: "get-activities" });
  const [activityList, setActivities] = useState<{activityList: Activity}>();
  useEffect(() =>{
    getActivities().then((data) =>{
      console.log("data",data)
      setActivities(data[`result`][`activity`])
    })
  },[])
